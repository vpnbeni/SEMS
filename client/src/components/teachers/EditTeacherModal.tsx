...
import { updateTeacher, hideEditTeacherModal } from "../../redux/slices/teacherSlice";
...
const EditTeacherModal: React.FC = () => {
  ...
  const { showEditModal, loading, selectedTeacher } = useSelector(
  ...
  // Populate form when selectedTeacher changes
  useEffect(() => {
    if (selectedTeacher) {
      setFormData({
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Name */}
          <div>
            <label htmlFor="edit-name" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
          ...
          {/* Employee ID */}
          <div>
            <label htmlFor="edit-employeeId" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`input w-full ${errors.employeeId ? 'input-error' : ''}`}
          ...
          {/* Department */}
          <div>
            <label htmlFor="edit-department" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
          ...
          {/* Status */}
          <div>
            <label htmlFor="edit-status" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
              Status
            </label>
            <select
              id="edit-status"
          ...
          {/* Email */}
          <div>
            <label htmlFor="edit-email" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
          ...
          {/* Phone */}
          <div>
            <label htmlFor="edit-phone" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
