...
export const ReportCardPreview = ({
  ...
  return (
    <div className="flex min-h-full flex-col border-[3px] border-double border-black bg-white p-2 text-black">
      {design.showHeader ? (
      ...
      <div className="mt-3 space-y-2" style={styleToCss(styles.footer)} onClick={() => select('footer')}>
      ...
      <div className="mt-8 flex justify-between px-2" style={styleToCss(styles.signatures)} onClick={() => select('signatures')}>
